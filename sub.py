...
weather_info_label = Label(root, by="white", font=("bold", 10))
...
#main function
def city_name():
    api_request = requests.get("https://api.openweathermap.org/data/2.5/weather?g=" +
              city_entry.get() + "&appid="+ "21cab08def7b27f4c2b55f3e2df28ea4")
